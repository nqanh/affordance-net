...
class ROIAlignmentLayerTest : public MultiDeviceTest<TypeParam> {
...
TYPED_TEST_CASE(ROIAlignmentLayerTest, TestDtypesGPU);

TYPED_TEST(ROIAlignmentLayerTest, TestGradient)
{
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
  ROIAlignmentParameter* roi_alignment_param = layer_param.mutable_roi_alignment_param();
  roi_alignment_param->set_pooled_h(6);
  roi_alignment_param->set_pooled_w(6);
