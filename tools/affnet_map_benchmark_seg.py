"""
Use the average confidence of the segmentation as the confidence for object classification.
If there is prediction of containability, we take the average of the confidence as the confidence
of this object classified as open container.
If there is no prediction of containability, then the confidence is 0.
